    ...
    <body>
        <div id="container">
            ...
            <div id="header">
                ...
                <a class="pull-left" id="logo" href="<?php echo ROOT_PATH; ?>index.php" title="<?php echo __('Support Center'); ?>">
                    <span class="valign-helper"></span>
                    <img src="<?php echo ROOT_PATH; ?>assets\default\images\nexiiot_black_crop.png" border=0 alt="<?php echo $ost->getConfig()->getTitle(); ?>">
