...
$title = ($ost && ($title=$ost->getPageTitle()))
    ? $title : ('NEXIIOT :: '.__('Staff Control Panel'));
...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?php echo ROOT_PATH ?>images/favicon-nexiiot-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="<?php echo ROOT_PATH ?>images/favicon-nexiiot-16x16.png" sizes="16x16" />
...
<?php } else {
    ...
    <title><?php echo ($ost && ($title=$ost->getPageTitle()))?$title:'NEXIIOT :: '.__('Staff Control Panel'); ?></title><?php
} # endif X_PJAX ?>
    <ul id="nav">
