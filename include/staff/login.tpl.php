...
<div id="loginBox">
    ...
    <h1 id="logo"><a href="index.php">
            ...
            <img src="logo.php?login" alt="NEXIIOT :: <?php echo __('Staff Control Panel'); ?>" />
        </a></h1>
    ...
    <form action="login.php" method="post" id="login" onsubmit="attemptLoginAjax(event)">
        ...
        ?>
            <fieldset style="padding-top:10px;">
                ...
                <button class="submit button pull-center" type="submit" name="submit"></i>
                    <?php echo __('Verify'); ?>
                </button>
            </fieldset>
        <?php
            ...
            <fieldset>
                <input type="text" name="userid" id="name" value="<?php
                                                                    echo $info['userid'] ?? null; ?>" placeholder="<?php echo __('Email or Username'); ?>" autofocus autocorrect="off" autocapitalize="off">
                ...
                <button class="submit button pull-right" type="submit" name="submit"></i>
                    <?php echo __('Log In'); ?>
                </button>
            </fieldset>
        <?php
