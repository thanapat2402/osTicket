...
$sortOptions = array(
    'id' => 'log.log_id', 'title' => 'log.title', 'type' => 'log_type', 'ip' => 'log.ip_address', 'date' => 'log.created', 'created' => 'log.created', 'updated' => 'log.updated'
);
        ...
        <div class="sticky bar opaque">
            <div class="content">
                ...
                <div id="actions" class="pull-right flush-right">
                    <button class="red button" type="submit" name="delete"><i class="icon-trash" g></i>
            ...
            ?>
                    <tr id="<?php echo $row['log_id']; ?>">
                        <td align="center" nowrap>
                            <input type="checkbox" class="ckb" name="ids[]" value="<?php echo $row['log_id']; ?>" <?php echo $sel ? 'checked="checked"' : ''; ?>>
                        </td>
